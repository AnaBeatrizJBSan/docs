---
title: "SELETOR Wired: Usuários com Variável"
description: Seleciona os usuários que possuírem a variável configurada.
sidebar:
  label: Usuários com Variável
  badge:
    text: RASCUNHO
    variant: note
infobox:
  ...
  title: Usuários com Variável
  # image: # url preenchida automaticamente

  # == Dados do Mobi ==
  revision: 71546
  classname: wf_slc_users_with_var
  name: "SELETOR Wired: Usuários com Variável"
  description: Seleciona os usuários que possuírem a variável configurada.
