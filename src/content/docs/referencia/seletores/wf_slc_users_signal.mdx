---
title: "SELETOR Wired: Habbos do Sinal"
description: Seleciona os usuários associados ao sinal recebido pela pilha.
sidebar:
  label: Habbos do Sinal
  badge:
    text: RASCUNHO
    variant: note
infobox:
