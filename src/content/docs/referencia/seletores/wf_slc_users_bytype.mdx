---
title: "SELETOR Wired: Habbos por Tipo"
description: Seleciona os usuários do tipo configurado, como Habbos, Bots ou Mascotes.
sidebar:
  label: Habbos por Tipo
  badge:
    text: RASCUNHO
    variant: note
infobox:
