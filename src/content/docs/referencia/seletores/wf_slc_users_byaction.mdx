---
title: "SELETOR Wired: Habbos por Ação"
description: Seleciona os usuários que estiverem executando a ação configurada.
sidebar:
  label: Habbos por Ação
  badge:
    text: RASCUNHO
    variant: note
infobox:
