---
title: "SELETOR Wired: Habbos com Item de Mão"
description: Seleciona os usuários que estiverem segurando o item de mão configurado.
sidebar:
  label: Habbos com Item de Mão
  badge:
    text: RASCUNHO
    variant: note
infobox:
  ...
  title: Habbos com Item de Mão
	# image: # url preenchida automaticamente

	# == Dados do Mobi ==
  revision: 69982
  classname: wf_slc_users_handitem
  name: "SELETOR Wired: Habbos com Item de Mão"
  description: Seleciona os usuários que estiverem segurando o item de mão configurado.
