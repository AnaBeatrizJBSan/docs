---
title: "SELETOR Wired: Habbos por Nome"
description: Seleciona os usuários com os nomes configurados.
sidebar:
  label: Habbos por Nome
  badge:
    text: RASCUNHO
    variant: note
infobox:
