---
title: "SELETOR Wired: Habbos na Equipe"
description: Seleciona os usuários que estiverem na equipe configurada.
sidebar:
  label: Habbos na Equipe
  badge:
    text: RASCUNHO
    variant: note
infobox:
