---
title: "WIRED Variável: Contexto Variável"
description: Esta variável armazena valores associados ao contexto atual da execução da pilha.
sidebar:
  label: Contexto Variável
  badge:
    text: RASCUNHO
    variant: note
infobox:
  ...
  title: Contexto Variável
	# image: # url preenchida automaticamente

	# == Dados do Mobi ==
  revision: 71472
  classname: wf_var_context
  name: "WIRED Variável: Contexto Variável"
  description: Esta variável armazena valores associados ao contexto atual da execução da pilha.
