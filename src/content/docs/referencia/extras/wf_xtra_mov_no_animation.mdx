---
title: "WIRED EXTRA: Cancelar Animação de Movimento"
description: Este extra remove a animação visual de movimento dos mobis afetados.
sidebar:
  label: Cancelar Animação de Movimento
  badge:
    text: RASCUNHO
    variant: note
infobox:
  ...
  title: Cancelar Animação de Movimento
	# image: # url preenchida automaticamente

	# == Dados do Mobi ==
  revision: 69540
  classname: wf_xtra_mov_no_animation
  name: "WIRED EXTRA: Cancelar Animação de Movimento"
  description: Este extra remove a animação visual de movimento dos mobis afetados.
