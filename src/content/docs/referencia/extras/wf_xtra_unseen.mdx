---
title: "WIRED EXTRA: Efeito Inédito"
description: Apenas um Efeito inédito pode ser ativado por vez.
sidebar:
  label: Efeito Inédito
  badge:
    text: RASCUNHO
    variant: note
infobox:
