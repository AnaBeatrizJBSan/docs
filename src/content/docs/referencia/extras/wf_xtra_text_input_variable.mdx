---
title: "WIRED Texto Extra: Captura Variável"
description: Este extra captura um texto digitado e o armazena na variável configurada.
sidebar:
  label: Captura Variável
  badge:
    text: RASCUNHO
    variant: note
infobox:
  ...
  title: Captura Variável
	# image: # url preenchida automaticamente

	# == Dados do Mobi ==
  revision: 71472
  classname: wf_xtra_text_input_variable
  name: "WIRED Texto Extra: Captura Variável"
  description: Este extra captura um texto digitado e o armazena na variável configurada.
