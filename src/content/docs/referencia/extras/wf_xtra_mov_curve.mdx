---
title: "WIRED EXTRA: Movimento Curva"
description: Este extra faz o mobi girar em curva durante movimentos configurados.
sidebar:
  label: Movimento Curva
  badge:
    text: RASCUNHO
    variant: note
infobox:
  ...
  title: Movimento Curva
  # image: # url preenchida automaticamente

  # == Dados do Mobi ==
  revision: 74952
  classname: wf_xtra_mov_curve
  name: "WIRED EXTRA: Movimento Curva"
  description: Este extra faz o mobi girar em curva durante movimentos configurados.
  product_name: "Add-on WIRED: Movimento Curva"
