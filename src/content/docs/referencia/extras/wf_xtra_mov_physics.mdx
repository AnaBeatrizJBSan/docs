---
title: "WIRED EXTRA: Física do Movimento"
description: Este extra nos ajuda a manter a altura de um mobi ou fazer com que ele atravesse outros mobis ou jogadores enquanto ele está em movimento
sidebar:
  label: Física do Movimento
  badge:
    text: RASCUNHO
    variant: note
infobox:
