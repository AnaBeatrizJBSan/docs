...
Se tiver uma ideia, dúvida ou encontrar um problema, abra uma [issue no GitHub](https://github.com/WiredClub/docs/issues). Para conversar com a comunidade, entre no [Discord do Wired Club](https://discord.gg/TCaVCvDsbV).
