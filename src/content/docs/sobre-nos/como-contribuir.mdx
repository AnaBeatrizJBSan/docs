...
3. **Edite e visualize**
   ...
   As páginas ficam em `src/content/docs/`. Inicie o ambiente local e abra `http://localhost:4321/docs/`:
...
Use arquivos `.mdx` em `src/content/docs/`. O nome das pastas define a URL; por exemplo, `guias-praticos/primeiro-sistema.mdx` gera `/docs/guias-praticos/primeiro-sistema/`.
...
- Para páginas internas, prefira links a partir da raiz publicada, como `/docs/referencia/glossario/`.
