...
Use exatamente o endereço exibido em **Keep my email addresses private**. A opção **Block command line pushes that expose my email** também pode impedir o envio de commits que contenham outro e-mail. Se quiser aplicar a configuração a todos os repositórios do computador, acrescente `--global` ao comando:
